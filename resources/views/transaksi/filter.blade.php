            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body"> </br>
                        <p><a
                                href="/file-export?tanggalawal={{ Request::get('tanggalawal') }}&tanggalakhir={{ Request::get('tanggalakhir') }}&bank={{ Request::get('bank') }}&mitra={{ Request::get('mitra') }}&produk={{ Request::get('produk') }}">
